...
// SVG Icons (Reused from Login aesthetics)
...
const UserIcon = ({ className = "input-icon" }) => (
        ...
        <div className="signup-left">
          <div className="left-content">
            ...
            <h2 className="welcome-title">
              Join <span className="highlight">Homiq</span><br />Today
            </h2>
        ...
        <div className="signup-right">
          ...
          <form className="signup-form" onSubmit={handleSubmit}>
            ...
            <div className="role-selector">
              ...
              >
                <UserIcon className="role-icon-svg" />
                <span>Customer</span>
              </div>
              <div 
